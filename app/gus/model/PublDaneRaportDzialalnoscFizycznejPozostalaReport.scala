...
import gus.model.GusReportType.PublDaneRaportDzialalnoscFizycznejPozostala
import org.joda.time.DateTime
import org.joda.time.format.DateTimeFormat

case class PublDaneRaportDzialalnoscFizycznejPozostalaReport(fiz_regon9: String = "",
  fiz_nazwa: String = "",
  ...
  fizP_dataWpisuDoRejestruEwidencji: String = "",
  fizP_numerwRejestrzeEwidencji: String = "",
  fizP_OrganRejestrowy_Symbol: String = "",
  fizP_OrganRejestrowy_Nazwa: String = "",
  fizP_RodzajRejestru_Symbol: String = "",
  fizP_RodzajRejestru_Nazwa: String = "") extends GusReport(PublDaneRaportDzialalnoscFizycznejPozostala) {
