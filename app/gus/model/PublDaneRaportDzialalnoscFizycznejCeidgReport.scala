...
import gus.model.GusReportType.PublDaneRaportDzialalnoscFizycznejCeidg
import org.joda.time.DateTime
import org.joda.time.format.DateTimeFormat

case class PublDaneRaportDzialalnoscFizycznejCeidgReport(fiz_regon9: String = "",
  fiz_nazwa: String = "",
  ...
  fizC_dataWpisuDoRejestruEwidencji: String = "",
  fizC_numerwRejestrzeEwidencji: String = "",
  fizC_OrganRejestrowy_Symbol: String = "",
  fizC_OrganRejestrowy_Nazwa: String = "",
  fizC_RodzajRejestru_Symbol: String = "",
  fizC_RodzajRejestru_Nazwa: String = "",
  fizC_numerTelefonu: String = "",
  fizC_numerWewnetrznyTelefonu: String = "",
  fizC_numerFaksu: String = "",
  fizC_adresEmail: String = "",
  fizC_adresStronyInternetowej: String = "") extends GusReport(PublDaneRaportDzialalnoscFizycznejCeidg) {
