...
import gus.model.GusReportType.PublDaneRaportDzialalnoscFizycznejRolnicza
import org.joda.time.DateTime
import org.joda.time.format.DateTimeFormat

case class PublDaneRaportDzialalnoscFizycznejRolniczaReport(
  fiz_regon9: String = "",
  fiz_nazwa: String = "",
  ...
  fiz_adSiedzUlica_Nazwa: String = "") extends GusReport(PublDaneRaportDzialalnoscFizycznejRolnicza) {
